...
describe("Login renderizado", () => {
    ...
    it('should render inputs and button correctly', () => {
        ...
        expect(getByText('En esta plataforma, podrás consultar las calificaciones de las prácticas que te asignan tus docentes. Revisa tus avances y mantente al tanto de tus resultados en tiempo real.')).toBeTruthy();
        expect(getByText('Para los Docentes')).toBeTruthy();
        expect(getByText('Como docente, tendrás la posibilidad de crear actividades y prácticas personalizadas para tus alumnos, y evaluarlas en tiempo real.')).toBeTruthy();
