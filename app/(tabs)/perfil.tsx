...
export default function Perfil() {
  ...
  const profileImageUrl =
    userData && userData.vchFotoPerfil
    ...
    <ScrollView style={tw`flex-1 bg-white p-4`}>
      ...
      <View style={tw`mb-4 p-4 bg-gray-100 rounded-lg`}>
        ...
        <Text style={tw`text-gray-800 mb-2`}>
          {userData ? userData.vchEmail : 'Cargando datos del usuario...'}
        </Text>
      ...
      <View style={tw`mb-6 p-4 bg-gray-100 rounded-lg`}>
        ...
        <Text style={tw`text-gray-600 mb-4`}>
          Aquí puedes cambiar tu contraseña actual por una nueva. Asegúrate de
          que tu nueva contraseña sea segura y diferente de la anterior para
          proteger tu cuenta.
        </Text>
