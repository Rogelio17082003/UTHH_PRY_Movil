            ...
            render={({ field: { onChange, onBlur , value } }) => (
                <>
                    <TextInput
                        ...
                        style={{ marginBottom: 14, backgroundColor: '#ffffff', fontSize:13}}
                        ...
                        outlineStyle={{ borderWidth: .5, borderRadius: 10 }}// esta linea hace el grosor de la linea y el color de la line, si marca herror se colocoa el color
                        error={!!errors[name]}
